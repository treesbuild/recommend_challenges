...
df = pd.DataFrame(index=range(200000),columns=range(3))
df[0] = np.random.randint(40,size=(200000,))
df[1] = np.random.choice(df_challenges.challenge_id,(200000,))
df[2] = np.random.choice([1,0], (200000,))
df[3] = np.random.choice([1], (200000,))
